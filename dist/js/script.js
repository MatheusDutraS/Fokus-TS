...
const audioPlay = new Audio('../dist/sons/play.wav');
const audioPause = new Audio('../dist/sons/pause.mp3');
const musica = new Audio('../dist/sons/luna-rise-part-one.mp3');
musica.loop = true
...
function alterarBanner(contexto) {
    banner.setAttribute('src', `../dist/imagens/${contexto}.png`)
...
function iniciarOuPausar() {
    ...
    startPauseBtnIcon.setAttribute('src', `../dist/imagens/pause.png`)
    intervaloId = setInterval(contagemRegressiva, 1000)
}

function zerar() {
    clearInterval(intervaloId)
    startPauseBtnIcon.setAttribute('src', `../dist/imagens/play_arrow.png`)
